...
// [[Rcpp::export]]
List bcfoverparRcppClean_ini( bool ini_bcf, SEXP treedraws_con, SEXP treedraws_mod,
                              double muscale_ini, double bscale0_ini, double bscale1_ini,
                              double sigma_ini, double pi_con_tau, double pi_con_sigma, double pi_mod_tau, double pi_mod_sigma,
                              ...
                              double trt_init = 1.0, bool verbose_sigma=false)
{
  ...
  *****************************************************************************/
  ...
  /*****************************************************************************
  /* Load the trees: match the cutpoints from XBCF with BCF matrix
  *****************************************************************************/
